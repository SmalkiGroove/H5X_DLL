...
void WandOfSpellTweak_init(pugi::xml_document& doc) {
	...
	assembly_patches.push_back({ PATCH_INT, 0x00E92350, 4, nullptr, 16, 0, 0, 0 });  //  1 - 16 charges

	assembly_patches.push_back({ PATCH_INT, 0x00E9232C, 4, nullptr, 4, 0, 0, 0 });   //  2 - Ice Bolt
	assembly_patches.push_back({ PATCH_INT, 0x00E92354, 4, nullptr, 16, 0, 0, 0 });  //  2 - 16 charges
	...
	assembly_patches.push_back({ PATCH_INT, 0x00E92368, 4, nullptr, 16, 0, 0, 0 });  //  7 - 16 charges
