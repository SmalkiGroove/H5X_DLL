...
void SkillEffectDisable_init(pugi::xml_document& doc) {
	...
	assembly_patches.push_back({ PATCH_WRTE, 0x0097B066, 1, nullptr, 0, 0, 0, "EB" }); // Luck of the Barbarian
	assembly_patches.push_back({ PATCH_WRTE, 0x00B4DFB8, 1, nullptr, 0, 0, 0, "EB" }); // Navigation
}
