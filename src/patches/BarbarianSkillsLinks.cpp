...
void BarbarianSkillsLinks_init(pugi::xml_document& doc) {
	...
	assembly_patches.push_back({ PATCH_INT, 0x0087542C, 4, nullptr, PERK_CORRUPTION_IMMUNE, 0, 0, 0 });      //208 - BLOCK_CORRUPTION
	...
	assembly_patches.push_back({ PATCH_INT, 0x00875468, 4, nullptr, PERK_UNLIMITED_RETALIATIONS, 0, 0, 0 }); //218 - UNLIMITED_RETALIATIONS
	assembly_patches.push_back({ PATCH_INT, 0x0087546E, 4, nullptr, PERK_FIERCE_RETALIATIONS, 0, 0, 0 });    //219 - FIERCE_RETALIATIONS
